...
Точка входа: \code{api/v1/schedule}
...
Точка входа: \code{api/v1/schedule/groups}
...
Точка входа: \code{api/v1/schedule/groups/<id>/types/<type>}
...
Точка входа: \code{api/v1/student}
